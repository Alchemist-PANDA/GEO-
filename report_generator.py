...
"""
        ...
        if not citation_found_parsed:
            ...
            report += "This indicates weak visibility — the AI knows about the brand but prioritizes competitors.\n\n"
        else:
            report += f"{brand} appears early in the AI response (position score: {position_score_parsed:.2f}) with {sentiment_parsed} sentiment. "
            report += "This indicates strong visibility in AI recommendations.\n\n"
