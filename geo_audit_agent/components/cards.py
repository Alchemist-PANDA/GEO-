...
def priority_card_html(title: str, description: str, severity: str) -> str:
    ...
    <div class="priority-card {sev.lower()}" style="border-left: 4px solid {border_color}; margin-bottom: 12px;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
            <h4 style="margin: 0; font-size: 1rem; font-weight: 700; color: #1E293B;">{title}</h4>
            {badge}
        </div>
        <p style="margin: 0; font-size: 0.85rem; color: #64748B; line-height: 1.4;">{description}</p>
    </div>
    """
...
def action_card_header_html(title: str, status: str, impact: str, effort: str) -> str:
    ...
    return f"""
    <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 15px; border-bottom: 1px solid rgba(0,0,0,0.06); padding-bottom: 10px;">
        <div>
            <h3 style="margin: 0 0 6px 0; font-size: 1.15rem; font-weight: 700; color: #1E293B; display: flex; align-items: center;">
