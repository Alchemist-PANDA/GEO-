def render_progress_bar(percentage: float, color_hex: str = "#7C3AED") -> str:
    ...
    return f"""
    <div style="width: 100%; background-color: rgba(124, 58, 237, 0.08); border-radius: 9999px; height: 8px; overflow: hidden; margin-top: 8px; border: 1px solid rgba(124, 58, 237, 0.06);">
