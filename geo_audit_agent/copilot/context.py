...
def build_context() -> dict:
    ...
    chart_context = st.session_state.get("copilot_context") or {}
    ...
    return {
        ...
        "geo_coverage_score": audit_results.get("geo_coverage_score"),
        ...
        "chart_data": chart_context.get("chart_data"),
        "fig_json": chart_context.get("fig_json"),
    }
