...
def extract_tfidf_keywords(text: str, top_n=20):
    ...
    try:
        ...
        stop_words = {
            ...
            'are', 'was', 'with', 'they', 'be', 'at', 'one', 'have', 'this', 'from', 'or', 'had', 'by', 'hot', 'word', 
            'but', 'some', 'what', 'there', 'we', 'can', 'out', 'other', 'were', 'all', 'there', 'when', 'up', 'use', 
            ...
            'river', 'car', 'feet', 'care', 'second', 'group', 'carry', 'took', 'rain', 'eat', 'room', 'friend', 
            ...
            'letter', 'until', 'mile', 'river', 'car', 'feet', 'care', 'second', 'group', 'carry', 'took', 'rain', 
            'eat', 'room', 'friend', 'began', 'idea', 'fish', 'mountain', 'stop', 'once', 'base', 'hear', 'horse', 
            'cut', 'sure', 'watch', 'color', 'face', 'wood', 'main', 'enough', 'plain', 'girl', 'usual', 'young', 
            ...
            'center', 'love', 'person', 'money', 'serve', 'road', 'map', 'rain', 'rule', 'govern', 'pull', 'cold', 
