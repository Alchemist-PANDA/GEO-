...
def render_remediation_hub(remediations):
    ...
    st.markdown(f"""
        <div style="background: rgba(255, 255, 255, 0.85); border: 1px solid rgba(124, 58, 237, 0.08); border-radius: 12px; padding: 20px; margin-bottom: 24px; box-shadow: 0 4px 12px -2px rgba(0,0,0,0.04);">
            <h3 style="margin: 0; font-size: 1.25rem; font-weight: 700; color: #1E293B; display: flex; justify-content: space-between; align-items: center;">
                <span>🛠️ Remediation Hub Progress</span>
                <span style="font-size: 1rem; color: #7C3AED; font-weight: 600;">{completed}/{total} Completed</span>
            </h3>
