...
def calculate_lift(pre_file, post_file):
    ...
    if score_diff > 0.01:
        conclusion = (
            f"The supplied scores differ by +{round(score_pct_change, 1)}%. "
            "This comparison alone does not establish that a deployment caused the change."
        )
    ...
    lift_report = {
        "evidence_type": "before_after_comparison_not_causal_validation",
